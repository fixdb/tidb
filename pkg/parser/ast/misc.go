...
func (n *TableOptimizerHint) Restore(ctx *format.RestoreCtx) error {
	...
	switch n.HintName.L {
	case "mpp_1phase_agg", "mpp_2phase_agg", "hash_agg", "stream_agg", "agg_to_cop", "read_consistent_replica", "index_join_first", "no_index_merge", "ignore_plan_cache", "limit_to_cop", "straight_join", "merge", "no_decorrelate":
		ctx.WritePlain(")")
		return nil
	}
	if n.HintName.L != "leading" && n.QBName.L != "" {
